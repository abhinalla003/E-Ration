        ...
        if ($_REQUEST['action'] == 'remove') {
            foreach ($_SESSION['cart'] as $key => $value) {
                if ($value['product_id'] == $_REQUEST['id']) {
                    ...
                    echo "<script>alert('Product has benn Removed..!');
                    ...
                    <form method="post" action="?action=remove&id=<?php echo $row['stock_id']; ?>">
                        ...
                        <div class="w3-container">
                            ...
                            <div class="w3-margin-top">
                                ...
                                <?php } ?>
                                <p>Total Members : 6 Persons</P>
                                <?php
                                    if($row['stock_name']!="Oil")
                                    {
                                    ?>
                                <p>Total Quantity :
                                    <?php echo $row['quantity'] * 6; ?> KG</P>
                                <?php
                                    }
                                    else
                                    {?>
                                <p>Total Quantity :
                                    <?php echo $row['quantity'] * 6; ?> Litres</P>
                                <?php } ?>
                                <?php
                                    if($row['stock_name']!="Oil")
                                    {
                                ...
                                <p style="font-size:1.3rem;margin-top:0.8rem;"><b>Amount :
                                        <?php echo $row['stock_price'] * $row['quantity'] * 6; ?> Rupees</b></p>
                            </div>
                        </div>
