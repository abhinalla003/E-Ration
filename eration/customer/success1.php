<?php
    ...
    {    
        ...
        $sql="INSERT INTO tbl_book (rationcard_no, date, amount)
        VALUES ('$rcard_no', '$date', '$int')";
        ...
        $sql5="INSERT INTO tbl_receipt (u_name, u_contact_no, amount, rationcard_no, date, time, state, d_id)
        VALUES ('$u_name', '$u_ph', '$int', '$rcard_no', '$date', '$time', '$state', '$d_id')";
