...
<body>
    <div class="invoice-box">
                            ...
                            if (count($_SESSION['cart']) >= 1) {
                                ...
                                while($row = mysqli_fetch_assoc($result3)) {
                                    foreach ($product_id as $id) {
                                       ...
                                       if ($stock_id == $id) {
                                        $total=$row['stock_price'] * $row['quantity'] * 6;
                        ?>
                    <tr>
                        ...
                        <?php
                                    ...
                                    {
                                    ?>
                        <td data-label="Quantity"><?php echo ($row['quantity'] * 6)."/KG"; ?></td>
                        <?php
                                    }
                                    else
                                    {?>
                        <td data-label="Quantity"><?php echo ($row['quantity'] * 6)."/Litres"; ?></td>
                        <?php } ?>
        ...
        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_blank">
            ...
            <input type="hidden" name="notify_url" value="http://localhost/eration1/eration/customer/success.php">
            <input type="hidden" name="return" value="http://localhost/eration1/eration/customer/success.php">
