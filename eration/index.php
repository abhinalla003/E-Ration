...
<body>
    ...
    <header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
        <div class="w3-text-white w3-margin-top" style="padding:48px;">
            ...
            <span class="w3-xxlarge w3-hide-large w3-hide-medium" style="margin-top:-20px;">You Want Your <div
            ...
            <p><button class="w3-button w3-padding-large w3-hover-opacity w3-large w3-margin-top w3-round-large"
            ...
            <div id="id01" class="modal">
                ...
                <form class="modal-content animate" action="" method="post">
                    ...
                    <div class="container w3-card">
                        <label for="rcard_no" style="color: #000;"><b>Ration Card No</b></label>
                        <input type="number" placeholder="Enter Ration Card No" maxlength="15" name="rcard_no"
                            required><br>
                        <button type="submit" class="w3-round-large" name="btnsubmit">Login</button>
                    </div>
                </form>
                <?php
