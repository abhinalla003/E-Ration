...
if(isset($_SESSION['user']))
{
  ...
  <?php
      ...
      ORDER BY tbl_complaint.complaint_id";
              ...
              <table class="table">
                ...
                ?>
                  <tr>
                    ...
                    <td data-label="Complaint ID"><?php echo $row['complaint_id']; ?></td>
                    ...
                    <td data-label=""><a href="print_complaints.php?c_id=<?php echo $row['complaint_id']; ?>" class="btn">Print</a></td>
                  </tr>
                  <?php
                        $n=$n+1;
                      }
