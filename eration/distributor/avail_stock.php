        ...
        <div class="home-content">
            <div class="add-distributor">
              ...
              if (isset($_REQUEST['submit'])) {
                ...
                //fetch user stock
                $sql2 = "SELECT * FROM tbl_user_stock WHERE stock_name='$item'";
                $result2 = mysqli_query($conn, $sql2);
                $u_stock = mysqli_fetch_assoc($result2);
                $u_quan = $u_stock['quantity'];
                ...
                foreach ($d_customers as $d_customer) {
                  ...
                  $sql9 = "SELECT * FROM tbl_book where rationcard_no='$rc' AND ration_grant='1'";
                ...
                $p_quan = $p_stock['quantity'];
                $u_quan = $u_quan * $flag;
                $total_stock = $p_quan - $u_quan;
                ...
                if ($count == 1) {
                  ...
                  $sql5 = "INSERT INTO tbl_available_stock (pds_no, d_id, d_fname, d_mname, d_lname, stock_id, 
                    stock_name, quantity)
                    VALUES ('$d_pds', '$d_id', '$d_fname', '$d_lname', '$d_lname', '$s_id', '$item', '$total_stock')";
