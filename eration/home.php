...
<div class="w3-top">
  <div class="w3-bar w3-card" id="myNavbar" style="background-color: #00545d; color: white!important;">
    ...
    <div class="w3-right w3-hide-small" style="margin-right:20px;">
        ...
        <a href="#team" onclick="w3_close()" class="w3-bar-item w3-button">Blogs</a>
        <a href="#contact" onclick="w3_close()" class="w3-bar-item w3-button">Contact Us</a>
        <a href="login/login.php" onclick="w3_close()" class="w3-bar-item w3-button w3-round-large" style="background-color:rgb(241, 213, 88); color:black;">Sign In</a>
    </div>
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small" style="font-weight: 600px; font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Do You Want Your Ration Card on<div style="color: rgb(243, 242, 176);margin-top:-20px;">Your Finger Tips?</div></span><br>
    <span class="w3-xxlarge w3-hide-large w3-hide-medium" style="margin-top:-20px;">You Want Your <div style="color: rgb(243, 242, 176);margin-top:-20px;">Ration Card on</div><div style="color: rgb(243, 242, 176);margin-top:-20px;">Your Finger Tips ?</div></span><br>
    <p class=" w3-hide-large w3-hide-medium" style="margin-top:-4rem;margin-left:10px;">You can Register Yourself Now to access new features provided by E-Ration.<br>
        E-Ration provides fast and secure platform for user to shop online.<br>
        E-Ration provides E-mail service to notify the user about their goods.<br>
        E-Ration supports Feedback System.<br>
        E-Ration provide Multi-Mode Payment System.</p>

        <p class=" w3-hide-small" style="margin-top:-8rem;margin-left:20px;">You can Register Yourself Now to access new features provided by E-Ration.<br>
        E-Ration provides fast and secure platform for user to shop online.<br>
        E-Ration provides E-mail service to notify the user about their goods.<br>
        E-Ration supports Feedback System.<br>
        E-Ration provide Multi-Mode Payment System.</p>

    <p><a href="login/signup.php" class="w3-button w3-padding-large w3-hover-opacity w3-large w3-margin-top w3-round-large" style="background-color:rgb(241, 213, 88); color:black; margin-left:30px;">Register Now</a></p>
  </div> 
...
<div class="w3-container w3-light-grey" style="padding:18px 16px" id="service">
  <div class="w3-row-padding">
    <div class="w3-col m6" >
      ...
      <p style="margin-left:20px;"><b>You can Register Yourself Now to access new features provided by E-Ration.</b><br>
        E-Ration provides fast and secure platform for user to shop online.<br>
        E-Ration provides E-mail service to notify the user about their goods.<br>
        E-Ration supports Feedback System.<br>
        E-Ration provide Multi-Mode Payment System.</p>
   ...
   <div class="w3-col m6">
      <img class="w3-image w3-round-large" src="https://rebellionvoice.com/wp-content/uploads/2017/12/images-1.jpg" alt="Buildings" width="700" height="394">
    </div>
  </div>
</div>
...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
  ...
  <div style="margin-top:48px">
    ...
    <p><i class="fa fa-phone fa-fw w3-xxlarge w3-margin-right"></i> Phone: +91 9054849782&nbsp +91 93270 21597</p>
    ...
    <form action="send_request.php" method="post">
      ...
      <p>
        <div class="w3-center">
        <button class="w3-button w3-center w3-black" type="submit" name="btnsend_request">
