                        ...
                        <div class="login-form-content">
                            <form class="signin-form" method="post">
								<div class="one-frm">
									...
									<label>OTP</label>
									<input type="number" name="otp" id="otp" placeholder="Enter OTP" style="font-weight: bold;" required="">
								</div>
                                <button type="submit" class="btn btn-style mt-3 w3-theme-d2" name="btn-confirm-otp">Change Password</button>
